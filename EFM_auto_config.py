config_dict = {'UNIFIED_ROUTER_LINK_BW': 16, 'V': 36, 'D': 5, 'topo_name': 'RRG', 'paths': 'MD_Nexullance_IT_FFT3D nx=100 ny=100 nz=100 npRow=12_40EnrouteSamples', 'routing_algo': 'nonadaptive_weighted', 'benchmark': 'FFT3D', 'benchargs': ' nx=100 ny=100 nz=100 npRow=12', 'Cores_per_EP': 1, 'traffic_trace_file': '/users/ziyzhang/EFM_experiments/EFM_experiments/traffic_traces/FFT3D nx=100 ny=100 nz=100 npRow=12.csv'}
import os
import sys
