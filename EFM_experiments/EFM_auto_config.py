config_dict = {'UNIFIED_ROUTER_LINK_BW': 16, 'V': 36, 'D': 5, 'topo_name': 'RRG', 'identifier': 'MD_Nexullance_IT_8samples_autoscaled_FFT3D nx=100 ny=100 nz=100 npRow=12', 'routing_algo': 'nonadaptive_weighted', 'benchmark': 'FFT3D', 'benchargs': ' nx=100 ny=100 nz=100 npRow=12', 'Cores_per_EP': 1}
import os
import sys
...
if __name__ == "__main__":
    ...
    topo.pathdict_file=graph_data_path+f"/from_graph_pathdicts/{identifier}_{topo_full_name}.pickle"
