...
BENCH="Random"
BENCH_PARAMS=" iterations=128 messagesize=128"
BENCH="Alltoall"
BENCH_PARAMS=" bytes=10000"
# BENCH="FFT3D"
# BENCH_PARAMS=" nsPerElement=1 npRow=4"
# BENCH="PingPong"
...
if UNIFIED_ROUTER_LINK_BW:
    # EXP_SUFFIX+=f"ROUTER_LINKS_{UNIFIED_ROUTER_LINK_BW}GBps_{CPE}CPE"
    EXP_SUFFIX+=f"ROUTER_LINKS_{UNIFIED_ROUTER_LINK_BW}GBps_{CPE}CPE"
# if FASTER_ALLTOALL:
...
if __name__ == "__main__":
    ...
    # ep = EmberMPIJob(0,topo.getNumNodes(), numCores = CPE*EPR, nicsPerNode = EPR)
